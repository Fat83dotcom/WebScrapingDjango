...
class CoreLogservicos(models.Model):
    id = models.BigAutoField(primary_key=True)
    dt_hr_exec_func = models.DateTimeField(blank=True, null=True)
    func_portal = models.CharField(max_length=50, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'Core_logservicos'
